  ...
  return (
    <main className='bg-white p-8   '>
      <nav className='py-4 flex justify-between'>
        ...
        <section className=' min-h-fit flex justify-center flex-col'>
          <div className='grid grid-cols-1 md:grid-cols-2 col-start-1 py-20'>
            ...
            <div className=' p-4 m-6 flex flex-col justify-center items-left order2 md:order-2'>
              ...
              <h1 className='text-6xl  xl:text-6xl sm:py-2 xs:text-6xl xs:py-2 py-2 font-bold font-playfair'>Rishabh Kamath</h1>
              <div className='px-1 py-4 text-lg xl:text-lg sm:text-xl xs:text-lg text-justify tracking-tight font-dmsans'>Experienced in Deep Learning, I am dedicated to applying cutting-edge Neural Network designs to practical challenges. With a strong foundation in data science and computer vision, I prioritize teamwork, clear communication, and continuous learning. Let us connect and innovate together!</div>
             
            </div>
            
            {/* Image */}
            <div className=" p-2 m-2 flex justify-center items-center order-1 md:order-1 ">
            <Image src={rk} className='bg-gradient-to-r from-purple-300 to-purple-700 rounded-full w-80 h-80 md:w-80 md:h-80'  alt="dev-img"/>

            </div>
          </div>
        </section>
        <section className='bg-purple-300 min-h-fit flex '>
